...
const Clubs = () => {
  return (
    <div>
      {/* Hero section */}
      <div className="hero-section w-full h-[90vh] flex justify-center items-center">
        <section id="hero" className="flex flex-col md:flex-row items-center gap-6">
          <div className="md:w-1/2 text-center leading-6">
            ...
            <div className="md:w-1/2 pl-[9rem] md:items-center">
    ...
    <p className="border-t-2 mx-auto max-w-[90%] border-white"></p>
